...
namespace MRRML_Lib
{
    public class MRRML
    {
        ...
        public MRRML(String name, String text)
        {
            this.name = name;
            this.text = text;
        }

        public MRRML(String mrrml, bool parse)
        {
            MRRML tmp = MRRML.parse(mrrml);
            this.name = tmp.name;
            this.text = tmp.text;
        ...
        public override String ToString()
        {
            ...
            tmp += this.text.Length + ":" + this.text;
